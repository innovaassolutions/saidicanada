...
export default function ColocationConfigurator({ dictionary, selection, onUpdate }: Props) {
  return (
        ...
        <div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
            {colocationPricing.map((option) => (
              ...
              >
                <div className="text-sm font-medium text-forest-dark">{option.name}</div>
                <div className="text-xs text-warm-gray/70">{option.specs}</div>
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2">
            {bandwidthPricing.map((option) => (
              ...
              >
                {option.name} — ${option.monthlyCAD}/mo
              </button>
            ))}
          </div>
        </div>
