...
export default function ServerConfigurator({ dictionary, pricingData, showServers, showGPU, selections, onUpdate }: Props) {
  const items = [
          ...
          return (
            ...
            >
              <div className="mb-2 sm:mb-0">
                <div className="font-medium text-forest-dark">{t?.name ?? item.name}</div>
                <div className="text-xs text-warm-gray/70">{t?.specs ?? item.specs}</div>
              </div>
